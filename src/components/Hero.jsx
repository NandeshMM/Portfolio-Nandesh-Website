...
import profilePic from "../assets/NandeshProfile3.jpg"
...
const container=(delay)=>({
    ...
    visible:{
        x:0,
        opacity:1,
        transition:{duractio:0.5,delay:delay},
    }
})
const Hero = () => {
  return (
        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    initial="hidden"
                    animate="visible"
                        className='pb-16 text-5xl font-thin tracking-tight lg:mt-16 lg:text-8xl'>M M Nandesh</motion.h1>
                    <motion.span
            ...
            <div className='w-full lg:w-1/2 lg:p-8'>
                <div className='flex justify-center'>
                    ...
                    transition={{duration: 1,delay:1.2}}
                     src={profilePic} alt='M M Nandesh'/>
                </div>
            </div>
        </div>
    </div>
